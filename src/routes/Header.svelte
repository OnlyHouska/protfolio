...
<header>
  ...
  <nav
    class="justify-between font-semibold fixed text-lg inset-0 pl-4 pr-7 w-full flex flex-row z-40 text-[#a3a3a3] h-16 transition-all duration-300 bg-[#1a1919] py-2 lg:hover:h-20"
  >
    <div class="flex flex-row gap-4 h-12">
      <img src={logo} alt="Logo" />
      <p class="relative self-center">OnlyHouska</p>
    </div>
